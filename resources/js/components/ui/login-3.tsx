...
export default function Login06({
    ...
    return (
        <div className="flex items-center justify-center min-h-screen">
            <Card className="w-full max-w-sm rounded-[2rem] px-6 py-10 pt-14">
                <CardContent>
                    <form onSubmit={handleSubmit} className="flex flex-col items-center space-y-8">
                        ...
                        <div className="space-y-2 text-center">
                            ...
                            <p className="text-muted-foreground text-sm">
                                First time here?{" "}
                                <a href={signUpHref} className="text-foreground hover:underline">
                                    Sign up for free
                                </a>
                            </p>
                        </div>
                        ...
                        <div className="w-full space-y-4">
                            <div className="space-y-1.5">
                                <Label htmlFor="login06-email" className="sr-only">
                                    Email
                                </Label>
                                <Input
                                    id="login06-email"
                        ...
                        <p className="text-center text-xs w-11/12 text-muted-foreground">
                            ...
                            <a href={termsHref} className="underline hover:text-foreground">
                                Terms of Service
                            </a>{" "}
                            and our{" "}
