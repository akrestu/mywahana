...
export default function InspeksiTambangReInspeksi({ record }: Props) {
    ...
    return (
        <>
            <Head title="Re-Inspeksi Tambang" />
            <div className="flex flex-col gap-6 max-w-2xl">
                {step === 'review' && (
                    <>
                        <div><h2 className="text-xl font-bold">Re-Inspeksi Area Tambang</h2><p className="text-sm text-muted-foreground mt-0.5">{tanggal}</p></div>
