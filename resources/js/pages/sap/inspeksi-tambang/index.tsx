...
import { CalendarDays, ChevronRight, Mountain, Plus, ShieldAlert } from 'lucide-react';
            ...
            <div className="flex flex-col gap-6">
                ...
                {pendingReInspeksi.data.length > 0 && (
                    <div className="rounded-2xl border-2 border-yellow-300 bg-yellow-50/50 dark:bg-yellow-950/10 p-4 flex flex-col gap-3">
                        ...
                        <RecordList records={pendingReInspeksi} asRI base="/sap/inspeksi-tambang" />
                    </div>
                )}
                <div className="flex flex-col gap-3"><p className="text-sm font-bold uppercase tracking-wider text-muted-foreground">Inspeksi Saya</p><RecordList records={myRecords} base="/sap/inspeksi-tambang" /></div>
                {selesaiAsRI.data.length > 0 && (
                    <div className="flex flex-col gap-3"><p className="text-sm font-bold uppercase tracking-wider text-muted-foreground">Riwayat Re-Inspeksi Saya</p><RecordList records={selesaiAsRI} asRI base="/sap/inspeksi-tambang" /></div>
                )}
            </div>
        </>
    );
