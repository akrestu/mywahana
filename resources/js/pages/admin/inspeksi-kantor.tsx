...
import { Building2, Download, Lock, Search, Trash2 } from 'lucide-react';
    ...
    return (
        <>
            ...
            <DeleteRangeDialog
                ...
                endpoint="/admin/inspeksi-kantor/delete-range"
                title="Hapus Data Inspeksi Kantor"
                description="Ini akan menghapus permanen seluruh data Inspeksi Kantor pada rentang tanggal yang dipilih (mengikuti batas site admin, di luar filter tampilan saat ini). Tindakan ini tidak dapat dibatalkan."
            />
        </>
    );
}
